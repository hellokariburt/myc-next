  ...
  <div className="w-auto md:w-[150px]">
    ...
    <div className="relative">
      ...
      <select
        ...
        className="w-full pl-8 pr-3 py-2 border border-slate-300 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none"
      >
