...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://findopenmyc.com/mics/brooklyn' },
  openGraph: {
    title: 'Open Mics in Brooklyn | OpenMYC',
...
export default function Page() {
  return (
    <SeoListingPage
      ...
      borough={['brooklyn']}
      boroughKey="brooklyn"
      breadcrumbs={getBoroughBreadcrumbs('brooklyn')}
      pageUrl="https://findopenmyc.com/mics/brooklyn"
      dayLinksBorough="brooklyn"
    />
  );
}
